    ...
    builder: (context) {
      return BlocBuilder<StudentBloc, StudentState>(
        builder: (context, state) {
          // Use the latest student data from state if available
          final currentStudent =
              state is StudentDataLoaded ? state.student : student;
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              BBText(
                                data:
                                    '${currentStudent.goal.noOfAttempts}/${currentStudent.goal.value}', // Updated to use current data
                      ...
                      Column(
                        children: [
                          ...
                          BBText(
                            data: '${currentStudent.streakScore} Days',
                            style: context.textStyle.titleLarge?.copyWith(
                              fontWeight: FontWeight.w600,
                              fontSize: 27,
                            ),
