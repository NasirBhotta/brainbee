...
class _RedemptionBottomSheetState extends State<RedemptionBottomSheet> {
                  ...
                  children: [
                    if (widget.reward.requiresUserInput) ...[
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: widget.reward.inputPlaceholder ?? 'Enter required information',
                          prefixIcon: Icon(
                            _getInputIcon(),
                            color: BBColors.bodyText,
                          ),
                        ...
                        validator: (value) {
                          ...
                          if (widget.reward.inputLabel?.toLowerCase().contains('email') == true) {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: BBColors.yellowAccent.withOpacity(0.3)),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _buildConfirmationRow('Current Balance', '${widget.currentCoins} Coins'),
                      const SizedBox(height: 12),
                      ...
                      if (widget.reward.requiresUserInput && _inputController.text.isNotEmpty) ...[
                        const SizedBox(height: 12),
                        _buildConfirmationRow(
  ...
  void _confirmRedemption() async {
    ...
    final redeemedReward = widget.reward.copyWith(
      ...
      submittedInfo: widget.reward.requiresUserInput ? _inputController.text : null,
    );
  ...
  IconData _getInputIcon() {
    ...
    if (label.contains('id') || label.contains('username')) return Icons.person_outline;
