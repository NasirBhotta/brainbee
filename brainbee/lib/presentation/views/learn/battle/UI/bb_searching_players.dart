...
class _BbSearchingPlayersState extends State<BbSearchingPlayers>
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (!_opponentFound) _buildSearchingAnimation(),
                              if (!_opponentFound) const SizedBox(height: 40),
                              ...
                              _buildPlayerCard(
                                name:
                                    _opponentFound &&
                                            _currentRoom?.opponent != null
                                        ? _currentRoom!.opponent!.username
                                        : 'Searching...',
                                initial:
                                    _opponentFound &&
                                            _currentRoom?.opponent != null
                                        ? _currentRoom!.opponent!.username[0]
                                            .toUpperCase()
                                        : '?',
                                color:
                                    _opponentFound
  ...
  Widget _buildStatusMessage() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (_opponentFound ? Colors.green : BBColors.primaryColor)
            .withOpacity(0.1),
        borderRadius: BorderRadius.circular(12),
      ),
      child: Row(
